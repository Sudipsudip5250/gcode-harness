#!/bin/bash
# Screenshot Watcher - monitors for gcode screenshot signals
#
# This script watches the signal directory and captures screenshots
# when gcode signals that a specific UI state is ready.
#
# Usage: ./screenshot_watcher.sh [window_id]
#
# Start gcode with: /screenshot-mode on

set -e

SIGNAL_DIR="${XDG_RUNTIME_DIR:-/tmp}/gcode-screenshots"
...
echo "Enable in gcode with: /screenshot-mode on"
echo ""
