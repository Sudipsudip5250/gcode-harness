...
impl crate::tui::TuiState for App {
    ...
    fn status_notice(&self) -> Option<String> {
        if !self.is_remote
            && self.provider.uses_gcode_compaction()
    ...
    fn context_info(&self) -> crate::prompt::ContextInfo {
        ...
        if self.is_remote {
            ...
            let skip = if self.provider.uses_gcode_compaction() {
    ...
    fn info_widget_data(&self) -> crate::tui::info_widget::InfoWidgetData {
        ...
        crate::tui::info_widget::InfoWidgetData {
            ...
            cache_hit_info,
            is_compacting: if !self.is_remote && self.provider.uses_gcode_compaction() {
                let compaction = self.registry.compaction();
                compaction
                    .try_read()
