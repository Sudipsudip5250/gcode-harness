...
#[test]
fn test_subscription_command_shows_gcode_status_scaffold() {
    let _guard = crate::storage::lock_test_env();
    crate::subscription_catalog::clear_runtime_env();
    crate::env::remove_var(crate::subscription_catalog::GCODE_API_KEY_ENV);
    crate::env::remove_var(crate::subscription_catalog::GCODE_API_BASE_ENV);
    ...
    assert!(msg.content.contains("/login gcode"));
