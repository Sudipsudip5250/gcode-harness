use super::{Agent, GCODE_REPO_SOURCE_STATE, WORKING_GIT_STATE_CACHE};
use crate::logging;
...
impl Agent {
    ...
    pub(super) fn build_env_snapshot(
        ...
        let (gcode_git_hash, gcode_git_dirty) = match detail {
            EnvSnapshotDetail::Full => GCODE_REPO_SOURCE_STATE.clone(),
        ...
        EnvSnapshot {
            ...
            gcode_version: env!("GCODE_VERSION").to_string(),
            gcode_git_hash,
            gcode_git_dirty,
