//! Client-server protocol for gcode
//!
...
use gcode_batch_types::BatchProgress;
use gcode_message_types::{InputShellResult, ToolCall};
use gcode_plan::{PlanItem, VersionedPlan, next_runnable_item_ids, summarize_plan_graph};
use gcode_side_panel_types::{SidePanelSnapshot, snapshot_is_empty};
...
pub type ReloadRecoverySnapshot = gcode_selfdev_types::ReloadRecoveryDirective;
...
pub enum Request {
    ...
    SetCompactionMode {
        id: u64,
        mode: gcode_config_types::CompactionMode,
    },
    ...
    /// Query gcode agent's capabilities
...
pub enum ServerEvent {
    ...
    History {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        images: Vec<gcode_session_types::RenderedImage>,
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        available_model_routes: Vec<gcode_provider_core::ModelRoute>,
        ...
        #[serde(default)]
        compaction_mode: gcode_config_types::CompactionMode,
