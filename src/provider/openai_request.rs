pub(crate) use gcode_provider_openai::{
...
use gcode_provider_openai::OpenAiRequestLogLevel;
use serde_json::Value;

pub(crate) fn build_responses_input(messages: &[ChatMessage]) -> Vec<Value> {
    gcode_provider_openai::build_responses_input_with_logger(messages, |level, message| match level
    {
