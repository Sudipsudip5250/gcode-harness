...
It should be backed by a shared command registry in `gcode-client-core`, not hardcoded separately per UI.

## Data model additions

`gcode-client-core` should include a workspace layout state model:
