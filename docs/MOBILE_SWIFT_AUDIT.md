...
- `ios/Sources/GcodeMobile/AppModel.swift`
- `ios/Sources/GcodeMobile/ContentView.swift`
- `ios/Sources/GcodeMobile/ImagePickerView.swift`
- `ios/Sources/GcodeMobile/QRScannerView.swift`
- `ios/Sources/GcodeMobile/SpeechRecognizer.swift`
- `ios/Sources/GcodeKit/Connection.swift`
- `ios/Sources/GcodeKit/CredentialStore.swift`
- `ios/Sources/GcodeKit/GcodeClient.swift`
- `ios/Sources/GcodeKit/Pairing.swift`
- `ios/Sources/GcodeKit/Protocol.swift`
...
- `MobileAction`
- `MobileEffect`
- reducers/state machines in `gcode-mobile-core`
...
Current sources: `AppModel.connectSelected()`, `AppModel.disconnect()`, `AppModel.onDisconnected()`, `Connection.swift`, `GcodeClient.swift`
...
Current sources: `AppModel.applyHistory()`, `appendAssistantChunk()`, `replaceAssistantText()`, `GcodeClient.handleServerEvent()`
...
This audit completes milestone M3 at the documentation/planning level. The next implementation milestone is M4: expand `gcode-mobile-core` into the real shared mobile app state/effect/reducer/protocol core.
