#!/usr/bin/env python3
"""
gcode Live Monitor - Real-time activity dashboard

Connects to gcode's debug socket and displays live streaming events.
Run gcode serve in one terminal, then this monitor in another.

Usage: ./gcode_monitor.py [--socket PATH]
"""
...
def get_socket_path() -> str:
    """Get the gcode debug socket path"""
