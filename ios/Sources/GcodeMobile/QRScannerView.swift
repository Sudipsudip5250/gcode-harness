...
struct QRScannerView: View {
        ...
        NavigationStack {
            ZStack {
                ...
                if cameraPermissionGranted {
                    QRCameraView { uri in
                        if let parsed = parseGcodeURI(uri) {
                    ...
                    .overlay(alignment: .bottom) {
                        VStack(spacing: JC.Spacing.sm) {
                            ...
                            Text("Point at the QR code from **gcode pair**")
    ...
    private func parseGcodeURI(_ string: String) -> (host: String, port: UInt16, code: String)? {
