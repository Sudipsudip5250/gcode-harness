...
impl JcodeProvider {
    ...
    fn apply_runtime_profile() {
        ...
        crate::env::set_var("GCODE_ACTIVE_PROVIDER", "openrouter");
...
impl Provider for JcodeProvider {
    ...
    fn uses_gcode_compaction(&self) -> bool {
        self.inner.uses_gcode_compaction()
    }
...
mod tests {
    ...
    #[test]
    fn gcode_provider_enables_subscription_runtime_mode() {
    ...
    #[test]
    fn gcode_provider_name_and_default_model_are_curated() {
        let _guard = crate::storage::lock_test_env();
        crate::subscription_catalog::clear_runtime_env();
        let runtime = tokio::runtime::Runtime::new().expect("tokio runtime");
