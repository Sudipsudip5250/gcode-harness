...
impl Default for PairingForm {
    fn default() -> Self {
        Self {
            ...
            device_name: "gcode simulator".to_string(),
        }
    }
}
    ...
    pub fn for_scenario(scenario: ScenarioName) -> Self {
        match scenario {
            ScenarioName::Onboarding => Self {
                ...
                status_message: Some("Ready to pair with a gcode server.".to_string()),
                error_message: None,
                messages: Vec::new(),
            ...
            ScenarioName::ConnectedChat => {
                ...
                Self {
                    ...
                    status_message: Some("Connected to simulated gcode server.".to_string()),
                    error_message: None,
                    messages: vec![
                        ChatMessage {
            ...
            ScenarioName::ToolApprovalRequired => {
                ...
                state.messages.push(ChatMessage {
                    ...
                    text: "Tool approval required: bash: cargo test -p gcode-mobile-core."
                        .to_string(),
                });
            ...
            ScenarioName::NetworkReconnect => {
                ...
                state.status_message =
                    Some("Reconnecting to simulated gcode server...".to_string());
                state
            }
...
fn reduce(mut state: SimulatorState, action: SimulatorAction) -> Reduction {
    ...
    match action {
        ...
        SimulatorAction::Connected { session_id } => {
            ...
            state.status_message = Some("Connected to simulated gcode server.".to_string());
            state.error_message = None;
