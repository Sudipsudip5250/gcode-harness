...
**Examples:**
- `#project:gcode` - Project-specific
...
- [x] User control CLI (`gcode memory` commands)
...
Similar to how humans consolidate memories during sleep, gcode can run background consolidation to optimize the memory graph:
