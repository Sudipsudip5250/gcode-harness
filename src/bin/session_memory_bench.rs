...
use gcode::message::{ContentBlock, Role};
use gcode::process_memory;
use gcode::session::Session;
...
fn main() -> anyhow::Result<()> {
    ...
    let display_messages = gcode::tui::display_messages_from_session(&session);
    ...
    let client_memory = gcode::tui::transcript_memory_profile(
        &session,
