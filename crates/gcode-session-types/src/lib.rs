...
use gcode_message_types::{ContentBlock, Message, Role, ToolCall};
...
pub struct EnvSnapshot {
    ...
    pub provider: String,
    pub model: String,
    pub gcode_version: String,
    pub gcode_git_hash: Option<String>,
    pub gcode_git_dirty: Option<bool>,
    pub os: String,
    pub arch: String,
    pub pid: u32,
    pub is_selfdev: bool,
...
pub struct SessionSearchReport {
    ...
    pub scanned_gcode_sessions: usize,
    pub candidate_gcode_sessions: usize,
...
pub fn format_session_search_results(
    ...
    output.push_str(&format!(
        ...
        report.scanned_gcode_sessions,
        report.candidate_gcode_sessions,
