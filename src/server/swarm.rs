...
fn swarm_status_debounce_member_threshold() -> usize {
    ...
    CACHED
        .get_or_init(|| {
            let configured = std::env::var("GCODE_SWARM_STATUS_DEBOUNCE_MEMBER_THRESHOLD")
                .ok()
...
fn swarm_status_debounce_ms() -> u64 {
    ...
    CACHED
        .get_or_init(|| {
            let configured = std::env::var("GCODE_SWARM_STATUS_DEBOUNCE_MS")
                .ok()
...
pub(super) fn swarm_task_heartbeat_interval() -> Duration {
    Duration::from_secs(configured_positive_u64(
        "GCODE_SWARM_TASK_HEARTBEAT_SECS",
...
pub(super) fn swarm_task_stale_after() -> Duration {
    Duration::from_secs(configured_positive_u64(
        "GCODE_SWARM_TASK_STALE_AFTER_SECS",
...
pub(super) fn swarm_task_sweep_interval() -> Duration {
    Duration::from_secs(configured_positive_u64(
        "GCODE_SWARM_TASK_SWEEP_INTERVAL_SECS",
