...
const REGISTERED_COMMANDS: &[RegisteredCommand] = &[
    ...
    RegisteredCommand::public("/feedback", "Send feedback about gcode"),
    RegisteredCommand::public("/subscription", "Show gcode subscription status"),
    ...
    RegisteredCommand::public("/selfdev", "Open a new self-dev gcode session"),
    ...
    RegisteredCommand::public("/quit", "Exit gcode"),
...
impl App {
    ...
    pub fn suggestion_prompts(&self) -> Vec<(String, String)> {
        ...
        let is_new_user = crate::storage::gcode_dir()
            .ok()
            .and_then(|dir| {
