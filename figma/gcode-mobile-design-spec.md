# gcode mobile design spec

This concept is derived from the current native iOS client in:

- `ios/Sources/GcodeMobile/Theme.swift`
- `ios/Sources/GcodeMobile/ContentView.swift`
- `docs/IOS_CLIENT.md`

## Product framing

gcode mobile is not a terminal emulator. It is a touch-first remote control and conversation surface for a gcode server running on a developer’s laptop or desktop.
...
- `gcode-mobile-plugin/` generates editable screens directly in Figma
- `gcode-mobile-mockup.svg` gives a fast importable preview
