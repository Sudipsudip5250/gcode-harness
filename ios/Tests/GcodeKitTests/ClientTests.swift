...
func runClientTests() {
    ...
    do {
        ...
        assertEqual2(decoded.serverName, "gcode")
    ...
    do {
        print("  GcodeConnection URL/auth header wiring...")
        let connection = GcodeConnection(host: "example.com", port: 7643, authToken: "abc123")
