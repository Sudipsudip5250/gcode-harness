...
pub const OPENAI_COMPAT_PROFILE: OpenAiCompatibleProfile = OpenAiCompatibleProfile {
    ...
    setup_url: "https://github.com/bitan-del/gcode-harness#openai-compatible-providers",
    default_model: None,
    requires_api_key: true,
};
...
pub const GCODE_LOGIN_PROVIDER: LoginProviderDescriptor = LoginProviderDescriptor {
    id: "gcode",
    display_name: "Jcode Subscription",
    auth_kind: LoginProviderAuthKind::ApiKey,
    auth_state_key: LoginProviderAuthStateKey::Jcode,
    auth_status_method: "API key",
    aliases: &["subscription", "gcode-subscription"],
    menu_detail: "curated gcode subscription models",
    recommended: false,
