...
SOCKET_PATH = f"/run/user/{os.getuid()}/gcode-debug.sock"
MAIN_SOCKET_PATH = f"/run/user/{os.getuid()}/gcode.sock"
...
def main():
    ...
    if not os.path.exists(SOCKET_PATH):
        ...
        print("Make sure gcode server is running with debug control enabled.")
