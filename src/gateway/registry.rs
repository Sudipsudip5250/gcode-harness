...
use crate::storage;
use gcode_gateway_types::{PairedDevice, PairingCode};

// ---------------------------------------------------------------------------
// Device registry (persisted to ~/.gcode/devices.json)
// ---------------------------------------------------------------------------
...
impl DeviceRegistry {
    /// Load from ~/.gcode/devices.json
    pub fn load() -> Self {
        let path = match storage::gcode_dir() {
    ...
    /// Save to ~/.gcode/devices.json
    pub fn save(&self) -> Result<()> {
        let path = storage::gcode_dir()?.join("devices.json");
