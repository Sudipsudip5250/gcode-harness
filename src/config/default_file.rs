...
impl Config {
    ...
    pub fn create_default_config_file() -> anyhow::Result<PathBuf> {
        ...
        let default_content = r#"# gcode configuration file
# Location: ~/.gcode/config.toml
#
# Environment variables override these settings.
# Run `/config` in gcode to see current settings.
...
# How to apply the transcript inside gcode: insert|append|replace|send
mode = "send"
...
# ntfy_topic = "gcode-ambient-your-secret-topic"
...
# email_from = "gcode@example.com"
# email_smtp_host = "smtp.gmail.com"
# email_smtp_port = 587
# Password via env: GCODE_SMTP_PASSWORD (preferred) or config below
# email_password = ""
...
# telegram_bot_token = ""  # From @BotFather (prefer GCODE_TELEGRAM_BOT_TOKEN env var)
...
# discord_bot_token = ""     # From Discord Developer Portal (prefer GCODE_DISCORD_BOT_TOKEN env var)
